...
sub format_content {
	...
	my %alignment_style = ('center'=>'margin:auto;width:70%',
	...
	foreach my $line (@lines) {
		if ($line =~ m/$re/) {
			...
			!defined($4) ? $align=$alignment_style{$default_alignment} : $align=$alignment_style{$4};	
			$line = "<div style='$align;border:1'><iframe src='$1' height='$height' width='$width' style='border-width:0; margin-left:auto; margin-right:auto' frameborder='0' scrolling='no'></iframe></div>";
		}
		$$content .= $line . "\n";
	}
	return $content;
