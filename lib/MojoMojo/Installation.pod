...
SQLite, mysql or Pg - sqlite by default). The setting you change is connect_info
in the Model::DBIC Block.
...
in your bin directory. or alternatively:
...
There is no step four. Have fun exploring MojoMojo, the default login/pass is
admin/admin.